...
<body class="bg-stone-300">
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 mt-[-3rem]" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="medecins" class="block py-2 pr-4 pl-3 text-stone-700 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white" aria-current="page">Home</a>
                        </li>
                        <li>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody id="rsrvtioncard">
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="accptbl px-6 py-4">
                                <button onclick="getIdAccptReservation(<?php echo $reservation['id'] ?>)" class="font-medium text-green-600 hover:cursor-pointer">Accepter</button>
                            </td>
    ...
    function getIdReservation(reservation_ID) {
        document.getElementById("reservation_ID_annuler").value = reservation_ID;
        document.getElementById("cancelReservationForm").submit();
    };

    function getIdAccptReservation(reservation_ID) {
        document.getElementById("reservation_ID_confirmer").value = reservation_ID;
        document.getElementById("acceptReservationForm").submit();
    };
